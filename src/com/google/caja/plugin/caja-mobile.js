...
var caja = (function () {
    ...
    function configure(config, callback) {
        if (!window.Object.FERAL_FRAME_OBJECT___) {
        ...
        loadCajaFrame('es53-taming-frame-mobile', function (tamingFrame) {
            ...
            function makeES5Frame(div, uriPolicy, callback) {
                ...
                loadCajaFrame('es53-guest-frame-mobile', function (guestFrame) {
    ...
    function initFeralFrame(aWindow) {
        if (aWindow.Object.FERAL_FRAME_OBJECT___ === aWindow.Object) {
            return;
        }
